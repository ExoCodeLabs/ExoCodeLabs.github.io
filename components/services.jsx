import { Code, Cpu, Globe, Smartphone, Cloud, MessageSquare, LinkIcon, BotIcon as Robot } from "lucide-react"
...
const services = [
  ...
  },
  {
    ...
    description: "Native and cross-platform mobile apps for iOS Android devices.",
  },
  {
    icon: <Cloud className="w-12 h-12 text-orange-500" />,
    title: "Cloud Services",
    description: "Scalable and secure cloud solutions for storage, computing, deployment.",
  },
  {
    icon: <LinkIcon className="w-12 h-12 text-orange-500" />,
    title: "API Integration",
    description: "Seamless integration of third-party APIs and development custom for your business.",
  },
  {
  ...
  },
  {
    ...
    description: "Get expert advice on how AI and software solutions can benefit your business, at no cost.",
  },
]
